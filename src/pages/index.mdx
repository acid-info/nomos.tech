...
description: Nomos is a novel blockchain project that will address a network state's fundamental need for programmable privacy, sovereignty and interconnectedness.
---
